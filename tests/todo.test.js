...
test('Edit todo', async t => {
    await t
        .typeText(todoPage.input, 'abc')
        .pressKey('enter')

    await t
        .doubleClick(todoPage.firstTodoItem)
        .selectText(todoPage.editInput, 1)
        .pressKey('backspace')
        .typeText(todoPage.editInput, 'cd')
        .pressKey('enter')
...
test('complete all', async t => {
    await t
        ...
        .typeText(todoPage.input, 'c')
        .pressKey('enter')

        .typeText(todoPage.input, 'd')
        .pressKey('enter')
...
test('delete all completed', async t => {
